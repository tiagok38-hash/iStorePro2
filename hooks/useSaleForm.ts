...
export const useSaleForm = ({
    ...
    // Total should NOT include card fees. Card fees are external to the product value.
    ...
    const handleConfirmCardPayment = useCallback(({ payment, feeToAddToSale }: { payment: Payment; feeToAddToSale: number }) => {
        ...
        // Do NOT add fees to sale total. Using feeToAddToSale only for tracking if needed, but not affecting sale total.
