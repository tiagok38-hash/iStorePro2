                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 w-full sm:w-auto">
                        {permissions?.canCreateSale && (
                            <button onClick={() => setIsModalOpen(true)} className="flex-1 sm:flex-none px-3 py-2 bg-success text-on-primary rounded-md font-bold text-xs sm:text-sm uppercase tracking-wide shadow-sm">+ Venda</button>
                        )}
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {currentSales.length === 0 ? (
                                        ...
                                        return (
                                            <tr key={sale.id} className="border-b border-border hover:bg-surface-secondary text-xs sm:text-sm">
                                                ...
                                                <td className="p-2 sm:p-3">
                                                    <div className="flex items-center gap-1.5">
                                                        <span className="text-primary font-medium truncate max-w-[80px] sm:max-w-none">{customerMap[sale.customerId]?.name || 'N/A'}</span>
                                                ...
                                                <td className="p-2 sm:p-3">
                                                    <div className="flex gap-1 flex-wrap">
                                                        ...
                                                        {sale.payments.some(p => p.type === 'pending') && (
                                                            <span className="px-1.5 py-0.5 text-[10px] sm:text-xs font-bold rounded-full bg-red-100 text-red-700">Prom</span>
                                                        )}
                                                    </div>
                                                </td>
