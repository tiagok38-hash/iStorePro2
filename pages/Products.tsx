...
const Products: React.FC = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            {isBulkUpdateModalOpen && <BulkPriceUpdateModal allProducts={products} suppliers={suppliers} onClose={() => setIsBulkUpdateModalOpen(false)} onBulkUpdate={handleBulkUpdate} />}
            {isBulkLocationUpdateModalOpen && <BulkLocationUpdateModal allProducts={products} purchases={purchases} suppliers={suppliers} onClose={() => setIsBulkLocationUpdateModalOpen(false)} onBulkUpdate={handleBulkLocationUpdate} />}
