...
import { OnlineStatusIndicator } from './components/GlobalLoading.tsx';
        ...
        <div className="flex bg-background text-primary min-h-screen">
            ...
            <div className="flex-1 flex flex-col w-full min-w-0 pb-20 lg:pb-0">
                ...
                <main className="flex-1 p-6 lg:p-8 overflow-y-auto">
                    <Suspense fallback={<div className="w-full h-full flex items-center justify-center"><SpinnerIcon /></div>}>
...
const App: React.FC = () => {
    return (
        <ToastProvider>
            <UserProvider>
                <Router>
                    <Suspense fallback={<div className="w-screen h-screen flex items-center justify-center bg-background"><SpinnerIcon /></div>}>
                        <Routes>
                            {/* Public Auth Routes */}
