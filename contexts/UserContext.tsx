...
const fullPermissions: PermissionSet = {
  ...
  osCanAccessDashboard: true, osCanAccessCustomers: true, osCanAccessSuppliers: true,
  osCanCreatePurchases: true, osCanEditParts: true, osCanAccessElectronics: true,
