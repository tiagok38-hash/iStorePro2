...
export const appleProductHierarchy = {
    ...
    'Watch': {
        ...
        'Apple Watch Series 11 (2025) 42mm (GPS) Alumínio': { 'Padrão': ['Meia-noite', 'Estelar', 'Prata', 'Azul', 'Rose Gold'] },
        'Apple Watch Series 11 (2025) 46mm (GPS) Alumínio': { 'Padrão': ['Meia-noite', 'Estelar', 'Prata', 'Azul', 'Rose Gold'] },
