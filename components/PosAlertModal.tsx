...
const PosAlertModal: React.FC<PosAlertModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-[70]">
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md mx-4 text-center p-6 relative">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <button
            type="button"
            onClick={onConfirm}
            className={`px-6 py-2 text-white rounded-xl font-semibold ${confirmButtonClasses[variant]}`}
          >
            {confirmText}
          </button>
        </div>
