...
const BottomNav: React.FC = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-[#111827] border-t border-gray-800 lg:hidden z-50 pb-1">
            ...
            {user && (
                <div className="px-3 py-0.5 bg-gray-900/50 border-b border-white/5 flex justify-center items-center">
                    <span className="text-[9px] text-gray-400 font-medium uppercase tracking-widest truncate">
                        Usuário: <span className="text-gray-300">{user.name}</span>
                    </span>
                </div>
            )}
