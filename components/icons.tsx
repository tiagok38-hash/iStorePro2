...
export const AppleIcon = ({ className = '', ...props }: IconProps) => (
    <svg
        ...
        {...props}
    >
        <path d="M12 20.94c1.88 0 3.05-1.07 4.19-1.07.94 0 1.63.49 2.94.49 1.48 0 2.37-.89 2.37-2.14 0-.11 0-.21-.01-.32a5.45 5.45 0 0 1-2.22-4.49 5.37 5.37 0 0 1 2.37-4.43c-.76-1.12-2.13-1.87-3.66-1.87-1.12 0-2.16.51-3.15.51-.99 0-2.19-.51-3.32-.51-2.48 0-4.66 1.83-4.66 5.14 0 3.39 2.5 8.69 5.15 8.69z" />
        <path d="M12.07 8c.11-1.78 1.43-3.03 3.06-3 0 1.48-.99 3-2.67 3a4.23 4.23 0 0 1-.39 0z" />
    </svg>
);
