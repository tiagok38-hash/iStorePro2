...
// PDV: Modern shopping cart (based on Image 0)
export const CashRegisterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.831A1.125 1.125 0 0 0 18.141 5H4.498" />
...
// Relatórios: Bar chart with rising arrow (based on Image 1)
export const ChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 20h18M18 20v-4M14 20v-8M10 20v-6M6 20v-3m1-10 4-4 4 4 5-5m0 0h-3.75M21 7v3.75" />
    </Icon>
);
...
export const AppleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor" className="w-6 h-6" {...props}>
        <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 21.8-88.5 21.8-11.4 0-51.1-20.8-82.3-21.2-38.3-.5-81.4 22.8-103.8 61.3-46.7 82.3-12 214 33.1 278.4 22.5 32.6 48.2 66.4 83.1 65.1 33.5-1.3 46.2-21.6 86.8-21.6 40.2 0 52.3 21.6 87.4 20.9 34.9-.7 58.2-30.8 79.9-63 26.5-38.8 37.4-76.4 37.7-78.3-.7-.3-72-27.7-72.2-113.1zm-40-161.9c16.2-19.1 26.3-45.4 23.3-71.3-22.3.9-50.4 15.6-67.4 34.5-14.8 16.3-28.5 43.1-24.8 68.3 25.3 1.9 51.5-11.4 68.9-31.5z" />
    </svg>
);
