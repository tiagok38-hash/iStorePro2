    ...
    return (
        <div className="bg-surface rounded-[2.5rem] border border-gray-100 p-8 space-y-8 shadow-sm max-w-[886px]">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                {activeSubTab === 'garantia' && <ParameterManager permissions={permissions} title="Garantias (OS)" items={warranties} fields={[{ name: 'name', label: 'Nome', type: 'text' }]} api={{ add: addOsWarranty as any, update: updateOsWarranty as any, del: deleteOsWarranty as any }} fetchData={fetchData} />}
