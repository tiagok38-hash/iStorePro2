...
const ProductModal: React.FC<ProductModalProps> = ({
    ...
    return (
        <div className={`fixed inset-0 bg-black/60 backdrop-blur-sm z-[100] flex items-center justify-center font-sans md:p-4 ${isOpen ? 'animate-fade-in' : 'animate-fade-out'}`}>
            <form onSubmit={handleSubmit} className="bg-white w-full max-w-4xl h-full md:h-[90vh] max-h-[100dvh] flex flex-col md:rounded-3xl shadow-2xl overflow-hidden animate-scale-in">
                {/* Header Premium */}
                <div className="flex justify-between items-center p-4 md:p-6 border-b border-gray-100 bg-gray-50/50 sticky top-0 z-10 flex-none gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            <XCircleIcon className="h-5 w-5 md:h-6 md:w-6 group-hover:scale-110 transition-transform" />
                        </button>
                    </div>
                </div>
