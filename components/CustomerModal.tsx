...
import { SpinnerIcon, SearchIcon, EditIcon, CheckIcon, UserCircleIcon, PhotographIcon, CameraIcon, TrashIcon } from './icons.tsx';
...
const CustomerModal: React.FC<CustomerModalProps> = ({ entity, initialType, onClose, onSave, isSaving }) => {
    ...
    const modalContent = (
        <div className="fixed inset-0 flex justify-center items-center p-0 sm:p-4" style={{ zIndex: 99999 }}>
            ...
            {/* Modal Container */}
            <div className="relative bg-gray-50 w-full h-full sm:h-auto sm:max-h-[95vh] sm:rounded-lg shadow-2xl sm:max-w-3xl flex flex-col animate-fade-in-up overflow-hidden">
                {/* Header - Always visible */}
                <div className="flex justify-between items-center p-3 border-b bg-white shadow-sm flex-shrink-0">
                ...
                <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex justify-end p-3 bg-gray-50 border-t gap-2 flex-shrink-0">
