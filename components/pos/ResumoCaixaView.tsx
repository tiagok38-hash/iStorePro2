    ...
    return (
        <div className="space-y-4 md:space-y-6 animate-fade-in pb-20 md:pb-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-4 items-stretch">
                ...
                <div className="lg:col-span-8 glass-card p-3 md:p-4 flex flex-col justify-between relative overflow-hidden h-full">
                ...
                <div className="lg:col-span-4 flex flex-col gap-2 md:gap-3 h-full">
                    ...
                    <div className={`glass-card p-3 md:p-4 border-l-4 ${isOpen ? 'border-l-success' : 'border-l-red-500'} relative overflow-hidden flex flex-col justify-between gap-2 md:gap-4 h-full text-gray-700`}>
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center gap-3 md:gap-4">
                ...
                <div className="flex flex-1 flex-row flex-wrap items-center gap-2 md:gap-4 glass-card p-3 md:p-4 overflow-x-auto no-scrollbar">
            ...
            <div className="glass-card overflow-hidden">
                ...
                <div className="hidden md:block overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-gray-50/50 text-gray-500 uppercase text-[11px] font-black tracking-widest border-b border-white/20">
                            <tr>
