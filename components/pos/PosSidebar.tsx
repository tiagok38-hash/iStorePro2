...
export const PosSidebar: React.FC<PosSidebarProps> = ({ activeView, onViewChange }) => {
    ...
    return (
        <aside className="fixed bottom-0 w-full md:static md:w-20 md:h-full bg-gray-900/90 backdrop-blur-md border-r border-white/10 flex flex-row md:flex-col items-center justify-between md:justify-start px-2 md:px-0 py-0 pb-6 pt-2 md:py-6 text-white shrink-0 shadow-2xl z-20">
