                ...
                <div className="flex flex-col gap-1.5 flex-[1.5]">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full p-2 pl-9 md:pl-10 border rounded-lg text-xs md:text-sm bg-gray-50 border-gray-300 focus:ring-2 focus:ring-success/20 outline-none"
                        />
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="md:hidden divide-y divide-gray-100">
                    {sessions.length === 0 ? (
                        ...
                        <div key={session.id} className="p-1.5 bg-white hover:bg-gray-50 transition-colors">
